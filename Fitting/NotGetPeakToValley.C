#include "NotFit_PeakAndValley.C"
#include "TFile.h"
#include "TString.h"

using namespace std;

Result* NotFit_PeakAndValley(TH1F*  fhisto);

Result * NotGetPeakToValley(TString rootFileName = "Run_30_PMT_133_Loc_3_Test_S",string pathToData = "./"){
  ...
  Result * result = NotFit_PeakAndValley((TH1F*)rootFile->Get(hName));
